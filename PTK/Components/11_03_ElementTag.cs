...
{
    public class _11_03_ElementTag : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the _11_03_ElementTag class.
        /// </summary>
        public _11_03_ElementTag()
          : base("ET", "ElementTag",
        ...
        {
            pManager.AddTextParameter("Tags Are", "Tags", "Input the tags the element must contain", GH_ParamAccess.list,"N/A");
            pManager.AddIntegerParameter("Mode", "Mode", "Mode 0 - One of - The detail must contain one of the inputted tags" +
        ...
        {
            get { return new Guid("7dbd4d6c-34e1-4b54-98bc-d08d5178ae99"); }
        }
    }
}