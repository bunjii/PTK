...
namespace PTK
{
    public class PTK_4_2_KarambaExport : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            {
                pts.Add(nodes[i].Pt3d * CommonProps.ConversionUnit(Rhino.UnitSystem.Centimeters));
            }
            ...
            for (int i = 0; i < sups.Count; i++)
            {
                ...
                Point3d pt = pln.Origin * CommonProps.ConversionUnit(Rhino.UnitSystem.Centimeters);
            ...
            for (int i = 0; i < elems.Count; i++)
            {
                for (int j = 0; j < elems[i].SubElem.Count; j++)
                {
                    ...
                    Point3d _sPt = elems[i].SubElem[j].StrLn.From * CommonProps.ConversionUnit(Rhino.UnitSystem.Centimeters);
                    Point3d _ePt = elems[i].SubElem[j].StrLn.To * CommonProps.ConversionUnit(Rhino.UnitSystem.Centimeters);
