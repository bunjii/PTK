...
{
    public class _11_01_Length : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the _11_01_Length class.
        /// </summary>
        public _11_01_Length()
          : base("EL", "ElementLength",
              "Test length of elements",
        ...
        {
            get { return new Guid("622e8a26-4278-43b3-ab40-8398e147fa39"); }
        }
    }
}