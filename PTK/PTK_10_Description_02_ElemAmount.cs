...
namespace PTK
{
    public class PTK_10_Description_02_ElemAmount : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the PTK_10_Description_02_ElemAmount class.
        /// </summary>
        public PTK_10_Description_02_ElemAmount()
          : base("ElementAmountRule", "ElementAmountRule",
              "Description",
              "PTK", "Description")
        {
        }
        ...
        {
            get { return new Guid("7ead7702-30e5-42a5-bca7-9bc9e2439f31"); }
        }
    }
}