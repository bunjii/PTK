...
{ 
    class StructuralAnalysis
    {
        ...
        public double EulerForce(PTK_Section cs1, MatProps md1, int direction)
        {
            double euler_force = Math.Pow(Math.PI, 2) * md1.e_0_05 / SlendernessRatio(cs1, direction);
            return euler_force;
        }

        public double SlendernessRelative(PTK_Section cs1, MatProps md1, int direction)
        {
        ...
        public double InstabilityFactor(PTK_Section cs1, MatProps md1, int direction)
        {
        ...
        public double BucklingStrength(PTK_Section cs1, MatProps md1, int direction)
        {
        ...
        public double CompressionUtilization(PTK_Section cs1, MatProps md1)
        {
