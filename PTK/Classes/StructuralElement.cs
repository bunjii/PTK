...
namespace MyProject15_Karamba_try
{
    class ElementData
    {
        ...
        public double SlendernessRatio(CrossSectionData cs1, int direction)
        {
        ...
        public double EulerForce(CrossSectionData cs1, MaterialData md1, int direction)
        {
            double euler_force = Math.Pow(Math.PI, 2) * md1.e_0_05 / SlendernessRatio(cs1, direction);
            return euler_force;
        }

        public double SlendernessRelative(CrossSectionData cs1, MaterialData md1, int direction)
        {
        ...
        public double InstabilityFactor(CrossSectionData cs1, MaterialData md1, int direction)
        {
        ...
        public double BucklingStrength(CrossSectionData cs1, MaterialData md1, int direction)
        {
        ...
        public double CompressionUtilization(CrossSectionData cs1, MaterialData md1)
        {
        ...
        public double CompressionUtilizationAngle(CrossSectionData cs1, MaterialData md1)
        {
            double utilization = 0;
            double utilization_dir1 = 0;
            double utilization_dir2 = 0;
        ...
        public double TensionUtilization(CrossSectionData cs1, MaterialData md1)
        {
            double utilization = 0;
        ...
        public double BendingUtilization(CrossSectionData cs1, MaterialData md1)
        {
            double utilization = 0;
        ...
        public double CombinedBendingAndAxial(CrossSectionData cs1, MaterialData md1)
        {
            double utilization = 0;
            double utilization1 = 0;
            double utilization2 = 0;
