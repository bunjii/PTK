...
namespace PTK
{
    public class PTK_Element
    {
        ...
        */
        ...
        #region methods
        public PTK_Element Clone()
        {
            return (PTK_Element)MemberwiseClone();
        }
        ...
        */
        ...
        public static PTK_Element FindElemById(List<PTK_Element> _elems, int _eid)
        {
            PTK_Element tempElem;
